[[siren-federate-getting-started]]
== Getting Started
...
[source,bash,subs=attributes+]
-----------------------------------------------------------
$ ./bin/elasticsearch-plugin install file:///PATH-TO-SIREN-FEDERATE-PLUGIN/siren-federate-{elasticsearch-version}-{siren-version}-SNAPSHOT-plugin.zip
-> Downloading file:///PATH-TO-SIREN-FEDERATE-PLUGIN/siren-federate-{elasticsearch-version}-{siren-version}-SNAPSHOT-plugin.zip
[=================================================] 100%  
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
[[siren-federate-starting-elasticsearch]]
